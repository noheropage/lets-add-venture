...
function Map() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      const climbAPIData = await API.getClimb(
        `${geoCode.lat}`,
        `${geoCode.lng}`,
        `${distance}`
      );
  ...
  return (
    <div className="container map-background">
      ...
      <MapContainer className="map-page" allResults={climbData}>
      ...
      <div className="justify-content-center search-bar pt-4 row">
        <Col xs={8} sm={8} md={6}>
          ...
          <Form.Group controlId="exampleForm.ControlSelect1">
            ...
            <Form.Control
              placeholder="search with a radius of... km"
              as="select"
